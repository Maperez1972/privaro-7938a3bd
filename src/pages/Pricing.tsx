...
const COPY = {
  es: {
    ...
    includesEnt: "TODO EN BUSINESS, MÁS",
    includes: "Incluye",
    ...
    plans: [
      ...
      },
      {
        ...
        features: [
          ...
          "Context Optimization — reduce tokens hasta 50-90% en tool outputs y logs",
          "Protección para RAG — Privaro Ingest (texto o fichero) + Retrieval Guard con control de acceso por fragmento",
          "SLA 24h por email",
        ],
      },
      {
    ...
    featureComparison: [
      ...
      { label: "Proveedores LLM", starter: "1 (OpenAI o Anthropic)", pro: "Multi-provider (todos)", enterprise: "Multi-provider (todos)" },
      ...
      { label: "Webhooks", starter: "Básico (1)", pro: "Avanzado (4)", enterprise: "A medida" },
      { label: "MFA admin / DPO", starter: false, pro: true, enterprise: true },
      { label: "Context Optimization (ahorro de tokens)", starter: false, pro: true, enterprise: true },
      { label: "Protección RAG (Ingest + Retrieval Guard)", starter: false, pro: true, enterprise: true },
      ...
      { label: "Docs ISMS ISO 27001:2022", starter: false, pro: false, enterprise: true },
      { label: "Onboarding técnico 1:1", starter: false, pro: false, enterprise: true },
    ...
    faqs: [
      ...
      { q: "¿Los datos de mis clientes pasan por vuestros servidores?", a: "Sí — el proxy intercepta la llamada, filtra el PII, y reenvía la versión limpia al LLM. En el plan Business puedes usar BYOK para que las API keys sean las tuyas. En Enterprise puedes tener instancia dedicada en tu propia VPC para máximo aislamiento." },
      ...
      { q: "¿Funciona con modelos open source o self-hosted?", a: "Sí, en el plan Business el multi-provider routing soporta cualquier endpoint compatible con la API de OpenAI — incluyendo Mistral, LLaMA vía Ollama o Groq, y modelos custom. Consulta la documentación de providers para la configuración específica." },
      { q: "¿Qué evidencia genera Privaro para cumplimiento GDPR / EU AI Act?", a: "El plan Business genera DPO Reports exportables en PDF con resumen de eventos PII, categorías detectadas y período analizado. El blockchain audit trail iBS añade evidencia irrefutable con hash inmutable por evento — útil en auditorías y due diligence." },
      { q: "¿Tenéis prueba gratuita?", a: "Sí — 14 días con acceso completo al plan Business sin tarjeta de crédito. Si necesitas más tiempo para evaluar en un entorno de producción real o tienes un caso de uso específico regulado, contáctanos directamente." },
      ...
      { q: "¿Protegéis también documentos y bases de conocimiento para RAG?", a: "Sí, a partir del plan Business. Privaro Ingest protege documentos (texto o subida de fichero — PDF, Word, Excel, CSV, correo) antes de indexarlos en tu vector store, y Retrieval Guard protege los fragmentos recuperados con control de acceso por rol antes de que lleguen al LLM. Más detalle en la página de protección para RAG." },
    ],
  },
  en: {
    badge: "Plans & pricing",
    ...
    includesEnt: "EVERYTHING IN BUSINESS, PLUS",
    includes: "Includes",
    ...
    plans: [
      ...
      },
      {
        ...
        features: [
          ...
          "Context Optimization — cut tokens up to 50-90% on tool outputs and logs",
          "RAG protection — Privaro Ingest (text or file) + Retrieval Guard with per-chunk access control",
          "24h email SLA",
        ],
      },
      {
    ...
    featureComparison: [
      { label: "Monthly requests", starter: "100,000", pro: "500,000", enterprise: "Custom (from 5M)" },
      ...
      { label: "Audit dashboard", starter: "Real-time (7 days)", pro: "Timeseries + periods", enterprise: "Custom" },
      { label: "LLM providers", starter: "1 (OpenAI or Anthropic)", pro: "Multi-provider (all)", enterprise: "Multi-provider (all)" },
      ...
      { label: "Context Optimization (token savings)", starter: false, pro: true, enterprise: true },
      { label: "RAG protection (Ingest + Retrieval Guard)", starter: false, pro: true, enterprise: true },
      ...
      { label: "ISMS ISO 27001:2022 docs", starter: false, pro: false, enterprise: true },
      { label: "1:1 technical onboarding", starter: false, pro: false, enterprise: true },
      { label: "SLA", starter: "—", pro: "24h email", enterprise: "99.9% uptime" },
    ...
    faqs: [
      ...
      { q: "Does my customer data pass through your servers?", a: "Yes — the proxy intercepts the call, filters the PII, and forwards the clean version to the LLM. In the Business plan you can use BYOK so the API keys are yours. In Enterprise you can have a dedicated instance in your own VPC for maximum isolation." },
      ...
      { q: "Does it work with open source or self-hosted models?", a: "Yes, on the Business plan multi-provider routing supports any OpenAI-API-compatible endpoint — including Mistral, LLaMA via Ollama or Groq, and custom models. Check the providers documentation for specific configuration." },
      { q: "What evidence does Privaro generate for GDPR / EU AI Act compliance?", a: "The Business plan generates exportable DPO Reports in PDF with a summary of PII events, detected categories and analyzed period. The iBS blockchain audit trail adds irrefutable evidence with an immutable hash per event — useful in audits and due diligence." },
      { q: "Do you have a free trial?", a: "Yes — 14 days with full access to the Business plan without a credit card. If you need more time to evaluate in a real production environment or have a specific regulated use case, contact us directly." },
      ...
      { q: "Do you also protect documents and knowledge bases for RAG?", a: "Yes, from the Business plan up. Privaro Ingest protects documents (text or file upload — PDF, Word, Excel, CSV, email) before they're indexed into your vector store, and Retrieval Guard protects retrieved chunks with per-role access control before they reach the LLM. See the RAG protection page for details." },
    ],
  },
};
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-border bg-card">
                  ...
                  <th className="text-center py-4 px-4 font-semibold text-primary bg-primary/5">Business</th>
