        ...
        {submitted ? (
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div><label htmlFor="brief-email" className="block text-sm text-muted-foreground mb-1.5">{t("beta.form.email")}</label><input id="brief-email" name="email" type="email" required className="w-full px-4 py-2.5 rounded-md bg-surface border border-border text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 transition-shadow" /></div>
              <div><label htmlFor="brief-concern" className="block text-sm text-muted-foreground mb-1.5">{t("beta.form.aiQuestion")}</label><textarea id="brief-concern" name="concern" rows={3} className="w-full px-4 py-2.5 rounded-md bg-surface border border-border text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 transition-shadow resize-none" /></div>
