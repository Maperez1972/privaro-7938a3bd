...
import { Scale, HeartPulse, BarChart3, Bot, Network, ArrowRight } from "lucide-react";
...
const cases = [
  ...
  { icon: Network, titleKey: "usecases.erp.title", descKey: "usecases.erp.desc", href: "/partners", accent: "from-violet-500/20 to-violet-500/5", border: "border-violet-500/20 hover:border-violet-500/50", iconBg: "bg-violet-500/10", iconColor: "text-violet-400", tag: "ERP & CRM Integrators" },
];
