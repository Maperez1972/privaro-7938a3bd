      ...
      <div className="max-w-3xl mx-auto text-center">
        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.7 }}>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="https://stoucpzrbasxhbdhmblm.supabase.co/storage/v1/object/public/public-docs/privaro-architecture-paper.pdf" download="privaro-architecture-paper.pdf" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-8 py-4 rounded-md bg-white text-gray-900 font-semibold text-base hover:bg-gray-100 transition-colors">
